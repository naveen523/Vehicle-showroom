...
<body>
   <form method="post" action="loginD.jsp">
                                        ...
                                        <tr>
                                            <td colspan="5" valign="top"><table width="741" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        ...
                                                        <td width="158" valign="top" style="background-image:url(images/index_26.gif);" class="menu"><a href=""></a> <br />
                                                            <a href=""></a> <br />
                                                            <a href=""></a><br />
                                                            <a href=""> </a><br />
                                                            <a href=""> </a><br />
                                                    ...
                                                    <td width="245" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            <tr>
                                                                <td class="border"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="86%" valign="top" class="text" align="center"><a href="#"><strong>LOGIN</strong></a><strong> </strong></td>
                                                                        </tr>
                                                                </table></td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td bgcolor="313131" class="border"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="313131">
                                                                        <tr>
                                                                            <td height="30" colspan="2" align="center">User Id &nbsp;&nbsp;&nbsp;<input type="text" name="userid"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="10" colspan="2" valign="top" align="center">Password  <input type="password" name="pswd"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td colspan="2"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td height="25" colspan="2" valign="top" class="text" align="center"><input type="submit" name="Submit" value="Submit"></td>
                                                                        </tr>
